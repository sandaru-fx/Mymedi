                ...
                {!emergencyData ? (
                    ...
                    >
                        {isLoading ? (
                            ...
                            <div className="glass-card p-0 rounded-[4rem] border-2 border-white/50 dark:border-slate-800 shadow-2xl overflow-hidden relative">
                                {(() => {
                                    ...
                                    return (
                                        <>
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-2 h-full min-h-[500px]">
                                                ...
                                                <div className="p-10 md:p-16 space-y-12 bg-white dark:bg-slate-900 flex flex-col justify-center text-left">
                                                    ...
                                                    <div className="flex gap-4">
                                                        <a href="tel:1990" className="flex-1 bg-red-600 text-white p-6 rounded-3xl font-black text-center text-lg shadow-xl shadow-red-600/20 flex items-center justify-center gap-3 active:scale-95 transition-transform">
                                                            <PhoneCall className="w-6 h-6" /> 1990 Call
                                                        </a>
                                                        <button
                                                            onClick={() => setEmergencyData(null)}
                                                            className="p-6 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-3xl active:scale-95 transition-transform"
                                                        >
                        ...
                        <div className="pt-10 flex justify-center">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={() => setEmergencyData(null)}
                                className="px-10 py-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full font-black uppercase tracking-widest text-xs flex items-center gap-3 shadow-lg"
                            >
                                <ChevronDown className="w-5 h-5 rotate-90" />
                                {isSinhala ? 'ආපසු යාමට' : 'Back to Situations'}
                            </motion.button>
                        </div>
                    </motion.div>
                )}
